...
public class MainMenuScreen extends Screen {
    ...
    public MainMenuScreen(GameEngine gameEngine) {
        super(gameEngine);
        mainMenu = gameEngine.loadBitmap("notgearjackassets/mainmenu.png");
        startGame = gameEngine.loadBitmap("notgearjackassets/startgame.png");
        title = gameEngine.loadBitmap("notgearjackassets/title.png");
    }
